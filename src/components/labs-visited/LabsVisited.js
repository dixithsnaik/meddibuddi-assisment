...
function LabsVisited() {
	...
	return <div className="labs-visited">
						...
						<div className="lab-card">
							...
							<div className="lab-card-details">
								...
								<div className="lab-card-loc">
									<img src="/assets/icons/location.svg"alt="location" className="card-icons"/>
									<span>{lab.area}</span>
								</div>
								<div className="lab-card-loc">
									<img src="/assets/icons/clock.svg" alt="clock"  className="card-icons" />
									<span>{lab.slot}</span>
								</div>
							</div>
						</div>
		...
		<div className="lab-trust">
			...
			<div className="lab-data">
				<div className="lab-data-contents">
					<img src="/assets/vectors/active-users/approved-centers.svg" alt="doctor" />
					<span>200+ Approved Diagnostic Centres</span>
				</div>
				<div className="lab-data-contents">
					<img src="/assets/vectors/active-users/lab-tests-types.svg" alt="doctor" />
					<span>1200+ Lab Tests Offered</span>
				</div>
				<div className="lab-data-contents">
					<img src="/assets/vectors/active-users/location-pincodes.svg" alt="doctor" />
